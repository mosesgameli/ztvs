...
- Added automated CI pipelines (`lint.yml`, `test.yml`, `security.yml`).
- Established protocol contract fixtures in `test/contracts/`.
- Created polyglot test fixtures (Go, Python, Node, Rust).
- Implemented engine performance benchmark suite.
...
- **Migrated project license from MIT to Apache License 2.0.**
- Scaled CI matrix to support Linux, macOS, and Windows.
